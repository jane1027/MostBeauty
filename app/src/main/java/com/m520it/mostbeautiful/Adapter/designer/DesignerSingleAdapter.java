 ...
 * @desc ${TODD}
 */
public class DesignerSingleAdapter extends MBBaseAdapter<DesignerMw> {


    public DesignerSingleAdapter(Context c) {
        super(c);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Picasso.with(mContext).load(mDatas.get(position).getRecommend_images().get(0)).
                ...
                error(R.drawable.no_wifi_icon_white).into(holder.recommend_images);
