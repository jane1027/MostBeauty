...
public class DeckChildViewThumbnail extends View {
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if (changed) {
            //设置图片的大小 // TODO: 2016/11/13 暂时修复
            mLayoutRect.set(0, 0, getWidth(), getHeight()+400);
    ...
    void updateThumbnailScale() {
        if (mBitmapShader != null) {
//            RectF shapeLayoutRect = mLayoutRect;
//            shapeLayoutRect.set(100,100,100,100);
            mScaleMatrix.setRectToRect(mBitmapRect, mLayoutRect, Matrix.ScaleToFit.CENTER);
