...
public class DeckChildViewHeader extends FrameLayout {
    ...
    protected void onFinishInflate() {
        ...
        mAuthorName = (TextView) findViewById(R.id.author_name_tv);
    ...
    public void rebindToTask(Drawable headerIcon, String headerTitle, int headerBgColor,String subTitle,String authorName) {
